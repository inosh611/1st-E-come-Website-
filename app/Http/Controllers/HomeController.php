...
class HomeController extends Controller
{
    public function redirect(){
            ...
            if($usertype=='1'){
                ...
                foreach($order as $order){
                    $total_reveniue = $total_reveniue+$order->price;
                }
                ...
                return view('admin.home',compact('total_product','total_order','total_user','total_reveniue','total_deliver','total_processing'));
    ...
    public function product_search(Request $request){
                $request_text=$request->search;
                $comment=comment::orderby('id','desc')->get();
                
                $product = product::where('title','LIKE',"%$request_text%")->orwhere('catagory','LIKE',"$request_text")->paginate(10);
                return view('home.userpage',compact('product','comment'));
    }
    ...
    public function products(){
        ...
        return view('home.all_product',compact('comment','product'));
    }


    public function about(){
        $comment=comment::orderby('id','desc')->get();
        return view('home.about',compact('comment'));
    }
